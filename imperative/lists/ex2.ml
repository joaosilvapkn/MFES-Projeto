...
let main (_: unit) : unit =
  ...
  schedule (Z.of_string "1") (Z.of_string "1") meet;
  start (Z.of_string "1") meet;
  end_ (Z.of_string "1") meet;
  start (Z.of_string "1") meet;
  join (Z.of_string "1") (Z.of_string "2") meet;
  join (Z.of_string "1") (Z.of_string "3") meet;
  leave (Z.of_string "1") (Z.of_string "3") meet;

  schedule (Z.of_string "2") (Z.of_string "1") meet;
  start (Z.of_string "2") meet;
  join (Z.of_string "2") (Z.of_string "4") meet;
  join (Z.of_string "2") (Z.of_string "5") meet;
  join (Z.of_string "2") (Z.of_string "6") meet;
  join (Z.of_string "2") (Z.of_string "2") meet;

  schedule (Z.of_string "3") (Z.of_string "7") meet;
  start (Z.of_string "3") meet;
  join (Z.of_string "3") (Z.of_string "8") meet;
  join (Z.of_string "3") (Z.of_string "9") meet;
  end_ (Z.of_string "3") meet;
